                                            ...
                                            <div class="col-md-6">
                                                <div class="input-group mb-3">
                                                    <input class="form-control w-100" type="text" name="phone"
                                                        id="phone" aria-label="" aria-describedby="basic-addon1">
                                                    <span class="text-danger"
                    ...
                    id="error-msg">{{ $errors->first('email') }}</span>
                                    ...
                                    <div class="card p-3 mb-3 book">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="input-group mb-3">
                                                    <input class="form-control w-100 required_for_valid"
                                                        type="text" placeholder="Pickup Location" name="pickup"
                                                        id="pickup" aria-label="Username"
                                                        aria-describedby="basic-addon1">
                                                    <span class="text-danger"
                                            ...
                                            <div class="col-md-12">
                                                <div class="input-group mb-3">
                                                    <input class="form-control w-100" type="text"
                                                        placeholder="Second Pickup Location" name="second_pickup"
                                                        id="second_pickup" aria-label="Username"
                                                        aria-describedby="basic-addon1">
                                                    <span class="text-danger"
                                                        id="error-pickup">{{ $errors->first('second_pickup') }}</span>
                                                    <input type="hidden" class="form-control" id="second_pickup_lat"
                                                        name="second_pickup_lat">
                                                    <input type="hidden" class="form-control" id="second_pickup_lng"
                                                        name="second_pickup_lng">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="input-group mb-3">
                                                    <input class="form-control w-100" type="text"
                                                        placeholder="Third Pickup Location" name="third_pickup"
                                                        id="third_pickup" aria-label="Username"
                                                        aria-describedby="basic-addon1">
                                                    <span class="text-danger"
                                                        id="error-pickup">{{ $errors->first('third_pickup') }}</span>

                                                    <input type="hidden" class="form-control" id="third_pickup_lat"
                                                        name="third_pickup_lat">
                                                    <input type="hidden" class="form-control" id="third_pickup_lng"
                                                        name="third_pickup_lng">
                                            ...
                                            <div class="col-md-12">
                                                <div class="input-group mb-3">
                                                    <input class="form-control w-100 required_for_valid"
                                                        type="text" placeholder="Drop Location" name="drop"
                                                        id="drop" aria-label="Username"
                                                        aria-describedby="basic-addon1">
                                                    <span class="text-danger"
                                    ...
                                    <div class="card p-3 mb-3 book">
                                        <div class="row">
                                            <div class="col-12">
                                                <h6 class="box-title">Full Address & Landmark</h6>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="input-group mb-3">
                                                    <input class="form-control w-100 required_for_valid"
                                                        type="text"
                                                        placeholder="Full address with building number / apartment number"
                                                        name="building_number" id="building_number"
                                                        aria-label="Username" aria-describedby="basic-addon1">
                                                    <span class="text-danger"
                                                        id="error-drop">{{ $errors->first('building_number') }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card p-3 mb-3 book date-option d-none">
                                        <div class="row">
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label" for="timepicker">@lang('view_pages.start_time')</p>
                                                </label>
                                                <input class="form-control datetimepicker required_for_valid"
                                    ...
                                    <div class="card p-3 mb-3 book">
                                        <div class="row">
                                            <div class="col-12">
                                                <h6 class="box-title">Invoice Details</h6>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="input-group mb-3">
                                                    <input class="form-control w-100 required_for_valid"
                                                        type="text" placeholder="Invoice Number"
                                                        name="invoicenumber" id="invoice_number"
                                                        aria-label="Username" aria-describedby="basic-addon1">
                                                    <span class="text-danger"
                                                        id="error-pickup">{{ $errors->first('invoicenumber') }}</span>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="input-group mb-3">
                                                    <input class="form-control w-100 required_for_valid"
                                                        type="text" placeholder="Invoice Amount"
                                                        name="invoiceamount" id="invoice_amount"
                                                        aria-label="Username" aria-describedby="basic-addon1">
                                                    <span class="text-danger"
                                                        id="error-pickup">{{ $errors->first('invoice_amount') }}</span>
                                                </div>
                                            </div>

                                        </div>
                                    </div>
                                    <div class="card p-3 mb-3 book" id="">
                                        <div class="row">
                                            <div class="col-12">
                                                <h6 class="box-title">Upload Invoice</h6>
                                            </div>
                                            <div class="col-md-6">
                                                <input class="form-control w-100 required_for_valid" type="file"
                                                    id="invoice_document" accept=".pdf">

                                            </div>
                                            <!-- <div><button onclick="validatePDF()">Upload</button></div> -->
                                        </div>
                                    </div>
                                    <div class="card p-3 mb-3 book">
                                        <div class="row">
                                            <div class="col-12">
                                                <h6 class="box-title">Cash To Be Collected</h6>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="input-group mb-3">
                                                    <input class="form-control w-100 required_for_valid"
                                                        type="text" placeholder="Cash To Be Collected"
                                                        name="cashtobecollected" id="cash_to_be_collected"
                                                        aria-label="Username" aria-describedby="basic-addon1">
                                                    <span class="text-danger"
                                                        id="error-pickup">{{ $errors->first('cash_to_be_collected') }}</span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card p-3 mb-3 book">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 chq-radio">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" id="cash" type="radio"
                                                        name="payment_opt_one" value="1" />
                                            ...
                                            <div class="col-md-6 chq-radio">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" id="pos" type="radio"
                                                        name="payment_opt_two" value="0" />
                                                    <label class="form-check-label book" for="pos">
                                                        <svg width="35" height="38" viewBox="0 0 40 44"
                                                            fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path
                                                                d="M36.7644 40.301H3.23563C1.44865 40.301 0 38.8523 0 37.0653V9.14645C0 7.35948 1.44865 5.91083 3.23563 5.91083H36.7644C38.5513 5.91083 40 7.35948 40 9.14645V37.0653C40 38.8523 38.5513 40.301 36.7644 40.301Z"
...
@push('booking-scripts')
    ...
    <script>
        function validatePDF() {
            var fileInput = document.getElementById('invoice_document');
            ...
            xhr.onreadystatechange = function() {
                if (xhr.readyState === 4 && xhr.status === 200) {
                    ...
                    // Store the PDF URL in a variable or perform further operations
                }
            };
            xhr.send(formData);
        }
        ...
        ['DOMContentLoaded'].forEach(function(eve) {
            ...
            window.addEventListener(eve, function() {
                ...
                function initialize() {
                    ...
                    var second_pickup_location = document.getElementById('second_pickup_location');
                    var third_pickup_location = document.getElementById('third_pickup_location');
                    ...
                    var second_pickup_location = new google.maps.places.Autocomplete(second_pickup);
                    var third_pickup_location = new google.maps.places.Autocomplete(third_pickup);
                    ...
                    second_pickup_location.addListener('place_changed', function() {

                        // pickUpMarker.setVisible(false);

                        var place = second_pickup_location.getPlace();
                        // console.log(place);
                        ...
                        removeMarkers(dropMarker);
                        secondpickUpLat = place.geometry.location.lat();
                        secondpickUpLng = place.geometry.location.lng();
                        secondpickUpLocation = new google.maps.LatLng(secondpickUpLat,
                            secondpickUpLng);

                        pickUpMarker = new google.maps.Marker({
                            position: secondpickUpLocation,
                            icon: icons['pickup'].icon,
                            draggable: true,
                            map,
                            // draggable: true,
                        ...
                        google.maps.event.trigger(pickUpMarker, 'click')
                        if (dropLocation)
                            calcRoute(secondpickUpLocation, dropLocation)

                        bindDataToForm(place.formatted_address, secondpickUpLat, secondpickUpLng,
                            'second_pickup_location');


                    });

                    third_pickup_location.addListener('place_changed', function() {

                        // pickUpMarker.setVisible(false);

                        var place = third_pickup_location.getPlace();
                        // console.log(place);
                        ...
                        removeMarkers(dropMarker);
                        thirdpickUpLat = place.geometry.location.lat();
                        thirdpickUpLng = place.geometry.location.lng();
                        thirdpickUpLocation = new google.maps.LatLng(thirdpickUpLat,
                            thirdpickUpLng);
                        ...
                        google.maps.event.trigger(pickUpMarker, 'click')
                        if (dropLocation)
                            calcRoute(thirdpickUpLocation, dropLocation)

                        bindDataToForm(place.formatted_address, thirdpickUpLat, thirdpickUpLng,
                            'third_pickup_location');
                    ...
                    fetch(etaUrl, {
                        ...
                        .then(result => {
                            if (result.success) {
                                ...
                                console.log(etaResponse, 'ETA RESPONSE TEST');
                                $('.etaprice').html(
                ...
                function createTripRequest() {
                    ...
                    var second_pickup_address = $('#second_pickup').val();
                    var third_pickup_address = $('#third_pickup').val();
                    var invoice_number = $('#invoice_number').val();
                    var invoice_document = $('#invoice_document').val();

                    var second_pickup_lat = $('#second_pickup_lat').val();
                    var second_pickup_lng = $('#second_pickup_lng').val();
                    var third_pickup_lat = $('#third_pickup_lat').val();
                    var third_pickup_lng = $('#third_pickup_lng').val();

                    var building_number = $('#building_number').val();
                    var cash_to_be_collected = $('#cash_to_be_collected').val();
                    var invoice_amount = $('#invoice_amount').val();
                    var invoice_amount = $('#invoice_amount').val();


                    if ($('#cash').is(':checked')) {
                        var payment_opt = $('#cash').val();
                    } else if ($('#pos').is(':checked')) {
                        var payment_opt = $('#pos').val();
                    }
                    ...
                    var tripData = {
                        ...
                        'second_pickup_address': second_pickup_address,
                        'third_pickup_address': third_pickup_address,

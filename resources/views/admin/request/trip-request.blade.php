        ...
        <div class="col-12">
            ...
            <div class="box">
                ...
                <div class="box-header bb-2 ">
                   <h5 class="off mt-3" style="font-weight: 900;color:orange;">
                        @lang('view_pages.order_id') : {{ $item->request_number }} : Not Started
                    </h5>
                </div>
               ...
               <div class="box">
                ...
                <div class="box-header bb-2 border-primary">
                    <h3 class="box-title">Requested End Points :</h3>
                </div>
